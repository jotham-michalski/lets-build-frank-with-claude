...
| [ADR-004](ADR-004-azure-hosting.md) | Hosting: Container Apps (Frank) + Static Web Apps (UI) | Accepted — partly superseded by 006, 009 |
...
| [ADR-009](ADR-009-frank-reads-own-resource-group.md) | Frank reads the classroom resource group (supersedes ADR-004's identity clause) | Accepted |
