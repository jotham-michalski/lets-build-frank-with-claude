...
cross-origin UI wiring) **and by ADR-009** (the managed identity /
no-role-assignments clause); scale-to-zero, `/healthz` probe,
one-RG-per-student and single-region decisions remain in force
**Date:** 2026-08
