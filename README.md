...
| [ADR-004](docs/adr/ADR-004-azure-hosting.md) | Hosting: Azure Container Apps | Accepted — partly superseded by 006, 009 |
...
| [ADR-009](docs/adr/ADR-009-frank-reads-own-resource-group.md) | Let Frank read what is running in the classroom resource group | Accepted |
